...
const Userdashboard = () => {
  ...
  return (
    <div className="flex">
      {/* Sidebar */}
      <aside
        className={`pt-[30px] w-[243px] rounded lg:pt-0 bg-green-600 text-white h-screen fixed top-0 left-0 overflow-y-auto transition-transform transform ${
      ...
      >
        <h1 className='pt-6 text-2xl font-bold text-center '>User Dashboard</h1>
            ...
            <ol className='pt-3 text-lg cursor-pointer'>
                <li className='pt-2 pb-2 pl-6 rounded-md hover:bg-green-500'>Track Orders</li>
                ...
                <li className='pt-4 pb-2 pl-6 rounded-md hover:bg-green-500'>Verify Profile</li>
                <li className='pt-4 pb-2 pl-6 rounded-md hover:bg-green-500'>Returns</li>
            </ol>
      </aside>
